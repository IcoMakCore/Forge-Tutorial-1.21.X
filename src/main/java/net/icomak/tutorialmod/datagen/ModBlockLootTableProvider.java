...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.ALEXANDRITE_ORE.get(),
                block -> createOreDrop(ModBlocks.ALEXANDRITE_ORE.get(), ModItems.RAW_ALEXANDRITE.get())); // First the block, second the item it drops
        ...
        this.add(ModBlocks.CARCASTAGNO_ORE.get(),
                block -> createOreDrop(ModBlocks.CARCASTAGNO_ORE.get(), ModItems.CARCASTAGNO_SHARD.get()));
    }
