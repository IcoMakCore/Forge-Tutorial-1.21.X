...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    // LIST of the blocks that when smelted give raw alexandrite
    @Override
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ...
        // Setup for shapeless recipe
        //Recipe for ALEXANDRITE from the BLOCK
        ...
        //Recipe for ALEXANDRITE from MAGIC_BLOCK
